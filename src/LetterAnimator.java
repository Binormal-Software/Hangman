...
public class LetterAnimator implements ChangeListener<Number>, ListChangeListener<Node> { 
	...
	/* sweet animation for children of any node, used here for letter tiles.
